...
class TodoList extends IcmsPersistableObject
{
	// constructor
	/**
	* constructor
...
class TodoListHandler extends IcmsPersistableObjectHandler
{

	public function __construct( & $db )
	{
		//IcmsPersistableObjectHandler(&$db, $db_table = '', $obj_class = '', $key_name = '', $identifier_name = false, $group_name = false)
		$this->IcmsPersistableObjectHandler($db, 'todolist', 'id', 'title', 'note', 'icms');
		$this->table = $db->prefix('todo_list');
	}
