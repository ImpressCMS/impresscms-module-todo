...
switch($op) {	
	...
	case 'list':
		...
		$icmsTpl->assign('load_jquery', $load_jquery);
		$icmsTpl->assign('gui_url', $gui_url);
		$icmsTpl->assign('tpl_path', MOD_TPL_PATH);
		$icmsTpl->assign('myurl', $myurl);
		...
		if ($admin) {
			$icmsTpl->display(MOD_TPL_PATH.'/todo_list.html');
		} else {
			$icmsTpl->display(MOD_TPL_PATH.'/todo_list_read.html');
		}
